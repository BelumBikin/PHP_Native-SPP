...
<div class="wrapper d-flex align-items-stretch">
      ...
      <h3>Data Transaksi <a href="tambah_transaksi.php" type="button" class="btn btn-success">Tambah Data</a></h3>
                ...
                <table class="table table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= " Rp. " . $r['jumlah']; ?></td>
                                <td><?= $r['status'];?></td>
                                <td><a href="ubah_transaksi.php?id_pembayaran=<?=$r['id_pembayaran']?>" class="btn btn-primary">Ubah</a>
                                <a href="hapus_transaksi.php?id_pembayaran=<?=$r['id_pembayaran']?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')" class="btn btn-danger">Hapus</a></td>
